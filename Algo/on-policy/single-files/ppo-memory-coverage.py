...
from utils import make_env, layer_init, matrix_norm, FastGLU
...
def parse_args():
    ...
    parser.add_argument("--env-id", type=str, default="nasim:LargeGen-PO-v0",
...
class Agent_Memory(nn.Module):
    ...
    def get_action_and_value(self, x, lstm_state, done, action=None, coverage_hist=None):
        ...
        if action is None:
            ...
            return action_probs.probs, action_probs.log_prob(action), action_probs.entropy(), self.critic(hidden), lstm_state
    ...
    for update in range(1, num_updates + 1):
        ...
        for step in range(0, args.num_steps):
            ...
            with torch.no_grad():
                ...
                if coverage_hist is None:
                    ...
                    action, logprob, _, value, next_lstm_state = agent.get_action_and_value(next_obs, next_lstm_state, next_done, coverage_hist=coverage_hist_norm)
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.num_envs, envsperbatch):
                ...
                new_a_prob, newlogprob, entropy, newvalue, _ = agent.get_action_and_value(
                    b_obs[mb_inds],
                ...
                if coverage_hist is None:
                    ...
                    loss = pg_loss - args.ent_coef * entropy_loss + v_loss * args.vf_coef + coverage_loss * approx_kl#0.025              
